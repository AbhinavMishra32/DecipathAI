...
const FEATURE_ROWS: FeatureRow[] = [
  ...
  {
    feature: "Agent research depth",
    free: "Basic evidence pass",
    pro: "Advanced multi-source pass",
    premium: "Deep multi-pass synthesis",
  },
  {
    feature: "Research calls per roadmap",
    free: "Up to 6",
    pro: "Up to 16",
    premium: "Up to 30",
  },
  {
    feature: "Subqueries per research call",
    free: "1",
    pro: "2",
    premium: "4",
  },
  {
    feature: "Results evaluated per query",
    free: "Up to 2",
    pro: "Up to 5",
    premium: "Up to 7",
  },
  {
    feature: "Pathway planning step budget",
    free: "Up to 4 planning steps",
    pro: "Up to 6 planning steps",
    premium: "Up to 10 planning steps",
  },
  {
    feature: "Roadmap synthesis step budget",
    free: "Up to 5 synthesis steps",
    pro: "Up to 7 synthesis steps",
    premium: "Up to 12 synthesis steps",
  },
  {
    feature: "Node lifecycle coverage",
    free: "Core lifecycle progression",
    pro: "Richer lifecycle transitions",
    premium: "Highest lifecycle and pathway fidelity",
  },
  {
    feature: "Execution map complexity",
    free: "Foundational roadmap structure",
    pro: "Deeper branching and convergence",
    premium: "Maximum roadmap complexity support",
  },
  {
    feature: "Data continuity",
    free: "Saved roadmaps retained",
    pro: "Saved roadmaps retained",
    premium: "Saved roadmaps retained",
  },
  {
    feature: "Best for",
    free: "Initial evaluation",
    pro: "High-consistency individual execution",
    premium: "Power users and multi-roadmap workflows",
  },
]
